...
const br = new Intl.NumberFormat('pt-BR', { style:'currency', currency:'BRL' };const setAmount = () => { if (valorInput) valorInput.value = rawCents ? br.format(rawCents/100) : ''; };
    ...
    if (valorInput) {if (valorInput) valorInput && valorInput && valorInput.addEventListener('beforeinput', (e) => {
        if (e.inputType === 'deleteContentBackward') {
          rawCents = Math.floor(rawCents/10);
          setAmount();
          e.preventDefault();
        }
      };if (valorInput) valorInput && valorInput && valorInput.addEventListener('input', (e) => {
        ...
        };};if (valorInput) valorInput && valorInput && valorInput.addEventListener('focus', () => {
